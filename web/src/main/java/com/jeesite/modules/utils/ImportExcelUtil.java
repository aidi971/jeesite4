                ...
                if (null != cell) {
                    if (c == 0) {
                        ...
                        if (cell.getCellType().equals(CellType.NUMERIC)) {
                            ...
                            map.put("student_id", studentId.substring(0, studentId.length() - 2 > 0 ? studentId.length() - 2 : 1));
                        } else {
                            map.put("student_id", cell.getStringCellValue());
                        }
                    } else if (c == 1) {
                        if (cell.getCellType().equals(CellType.NUMERIC)) {
                            String studentName = String.valueOf(cell.getNumericCellValue());
                            map.put("student_name", studentName.substring(0, studentName.length() - 2 > 0 ? studentName.length() - 2 : 1));
                        } else {
                            map.put("student_name", cell.getStringCellValue());// fid
                        }
                    } else if (c == 2) {
                        if (cell.getCellType().equals(CellType.NUMERIC)) {
                            String sex = String.valueOf(cell.getNumericCellValue());
                            map.put("sex", sex.substring(0, sex.length() - 2 > 0 ? sex.length() - 2 : 1));// 土地坐落
                        } else {
                            map.put("sex", cell.getStringCellValue());// 土地坐落
                        }
                    } else if (c == 3) {
                        if (cell.getCellType().equals(CellType.NUMERIC)) {
                            String studentNumber = String.valueOf(cell.getNumericCellValue());
                            map.put("student_number", studentNumber.substring(0, studentNumber.length() - 2 > 0 ? studentNumber.length() - 2 : 1));// 土地坐落
                        } else {
                            map.put("student_number", cell.getStringCellValue());// 土地坐落
                        }
                    } else if (c == 4) {
                        if (cell.getCellType().equals(CellType.NUMERIC)) {
